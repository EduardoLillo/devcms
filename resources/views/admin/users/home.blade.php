					...
					<div class="dropdown">
					     ...
					     Filtrar
					 	 ...
					 	 <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						     <a class="dropdown-item" href="{{ url('/admin/users/all') }}"><i class="fas fa-list"></i> Todos</a>
			...
			<table class="table mtop16">
				...
				<tbody>
					...
					<tr>
						...
						<td>{{ $user->lastname }}</td>
						<td>{{ $user->email }}</td>
						<td>{{ getUserRoleArray(null, $user->rol) }}</td>
						<td>{{ getUserStatusArray(null, $user->status) }}</td>
						<td>
							<div class="opts">
							<a href="{{ url('/admin/user/'.$user->id.'/edit') }}" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-user-edit" ></i>
							</a>
							</a>
							</div>
						</td>
